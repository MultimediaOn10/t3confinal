	...
	<body>
		...
		<div class="row">
			<div class="span3 skip-start">
            	...
            	<a class="fancy-text impressum" rel='group' href="#additional-content2">T3Con12 | Semersterarbeit im Kurs "Multimediales Informationsdesign" | Dozent: Dipl.-Des. Lothar B.Blum | created by: Stephan Fischer, Theresia Zorn, Liesa Burgey und Fabian Stein | DHBW Mosbach | Onlinemedien | 18.01.13</a>
        	</div> 
        	<div class="span8 video">
					<iframe width="640" height="480" src="http://www.youtube.com/embed/5pKOEjGa20I?autoplay=1&rel=0" frameborder="1" allowfullscreen></iframe>	
				</div> 
			<div class="span3">
