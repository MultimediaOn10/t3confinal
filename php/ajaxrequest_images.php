...
foreach ($alledateien as $datei) { // Ausgabeschleife
    //echo $datei."<br />"; //Ausgabe Einzeldatei
		...
		if (strpos($datei, "thumb")==false && $datei != "." && $datei != ".."){
			...
			$img="<div class='item'><a class='fancybox-images' data-thumbnail='../img/".$breakname."/".$datei_blanko."\"\"_thumb.jpg' href='../img/".$breakname."/".$datei_blanko.".jpg'>".$datei."</a><img href='../img/".$breakname."/".$datei_blanko."\"\"_thumb.jpg'/></div>";
		$img_array[]=$img;
		}		
